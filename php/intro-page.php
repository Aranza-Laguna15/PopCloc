...
<!-- Scroll to Top Button (Only visible on small and extra-small screen sizes) -->
                    ...
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <label class="col-lg-2 control-label">user@gmail.com </label>
                                </div>
                                ...
                                <div class="col-lg-10 col-lg-offset-2">
                                    <button type="submit" class="btn btn-warning">GUARDAR</form:button>
                                </div>
                            </div>
    ...
    <div class="portfolio-modal modal fade" id="ModalLeccion" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="tabbable tabs-left">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li><a href="#lB" data-toggle="tab" >NIVEL 2</a></li>
                                    <li><a href="#lC" data-toggle="tab">NIVEL 3</a></li>
                                    <li><a href="#lD" data-toggle="tab">NIVEL 4</a></li>
                                </ul>
                                     ...
                                     <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne"> BIENVENIDO A POP CLOC</a> </h4>
                                                ...
                                                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                                    <div class="panel-body">
                                                       <p> Pop Cloc te ayuda a mejorar tu ortografía brindandote en una serie de lecciones las reglas ortografícas y gramáticales, con las cuales podrás realizar tus ejercicios en tu movíl. </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="panel panel-default">
        ...
        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
          Palabras homófonas
                                                ...
                                                <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                                    <div class="panel-body">
                                                        <p>Las palabras homófonas son aquellas que se escriben diferente, pero suenan igual y tienen un significado distinto entre ellas, por ejemplo: </p>
                                                        ...
                                                        <p> Tienen igual pronunciación, pero su ortografía es distinta y su significado diferente. </p>
                                                        <h4> Recuerda: </h4>
                                                        <p> No confundir con las palabras homógrafas que son las que se pueden escribir y sonar igual, pero tienen diferente significado, por ejemplo: </p>
          ...
          Lección 1: Uso de la B y V</a></h4>
                                                ...
                                                <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                                    <div class="panel-body">
                                                        ...
                                                        <p> Ha<b>b</b>lar, Mue<b>b</b>le, <b>B</b>rillo, A<b>b</b>domen, <b>B</b>lando, <b>B</b>ronco</p>
                                                        <p> * Verbos que terminan en <b>-aba</b>, por ejemplo: </p>
                                                        <p> Salta<b>b</b>a, explota<b>b</b>a, termina<b>b</b>a, estudiá<b>b</b>amos </p>
                                                        <p>* Verbos que terminan en <b>-bir</b> o <b>buir</b>, por ejemplo: </p>
                                                        <p> Escri<b>b</b>ir, Reci<b>b</b>ir, Contri<b>b</b>uir, distri<b>b</b>uir </p>
                                                        <p> Excepto: Hervir, Servir, Vivir. </p>
                                                        <p>* Palabras con los prefijos <b>bi</b>, <b>bis</b> y <b>biz</b>, por ejemplo: </p>
                                                        <p> <b>B</b>icolor, <b>B</b>izcocho </p>
                                                        <p>* Palabras que comienzan con <b>bo</b> y les siguen las letras <b>d</b>, <b>f</b>, <b>n</b>, <b>r</b> y <b>t</b>, por ejemplo: </p>
                                                        <p> <b>B</b>otella, <b>B</b>onetería, <b>B</b>odega, <b>B</b>ofetada, <b>B</b>ordado </p>
                                                        ...
                                                        <p> * Palabras que cominezan con <b>eva</b>, <b>eve</b>,<b>evi</b>, <b>evo</b>, por ejemplo: </p>
                                                        <p> e<b>v</b>aporación, e<b>v</b>acuación, e<b>v</b>idente</p>
                                                        <p>* Palabras que comienzan con <b>vice</b>, <b>villa</b>, por ejemplo: </p>
                                                        <p> <b>V</b>icepresidente, <b>V</b>illano </p>
                                                        <p> Excepto: Bicentenario, Billar. </p>
                                                        <p>* Después de las sílabas <b>ol</b>, <b>pra</b>, <b>pre</b>, <b>pri</b>, <b>pro</b>, por ejemplo: </p>
                                                        <p> Inol<b>v</b>idable, pro<b>v</b>echo, pre<b>v</b>io</p>
                                                        <p>* Palabras que terminan con <b>vira</b>, <b>viro</b>, <b>ívora</b>, <b>ívoro</b>, por ejemplo: </p>
        ...
        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
         Lección 2: Uso de la C y S</a> </h4>
                                                ...
                                                <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                                                    <div class="panel-body">
                                                        <h3> Uso de la C </h3>
                                                        <p>* Verbos terminados en <b>ciar</b>, <b>cer</b>, <b>cir</b>, por ejemplo: </p>
                                                        ...
                                                        <h3> Uso de la S </h3>
                                                        <p>* Terminación Superlativa <b>isimo</b>, <b>isima</b>, por ejemplo: </p>
                                                        <p> Fuerti<b>s</b>imo, Lenti<b>s</b>imo </p>
                                                        <p>* Palabras que terminan en <b>sión</b> derivadas de las que terminan en <b>so</b>, <b>sor</b>, <b>sible</b>, <b>sivo</b>, por ejemplo: </p>
        ...
        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
         Lección 3: Uso de la Z</a> </h4>
                                                ...
                                                <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                                                    <div class="panel-body">
                                                        <h3> Uso de la Z</h3>
                                                        <p>* Se escribe <b>z</b> antes de <b>a</b>, <b>o</b>, <b>u</b> y al final de la silaba, por ejemplo: </p>
                                                        ...
                                                        <p>* Las palabras terminadas en <b>izo</b>, <b>iza</b>, <b>izar</b>, por ejemplo: </p>
                                         ...
                                         <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                            <div class="panel panel-default">
                                                <div class="panel-heading" role="tab" id="headingSix">
                                                    <h4 class="panel-title">
                                     <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSix" aria-expanded="true" aria-controls="collapseSix"> Lección 4: Uso de la G y J</a> </h4>
                                                </div>
                                                <div id="collapseSix" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingSix">
                                                    <div class="panel-body">
                                                        <h3> Uso de la G </h3>
                                                       <p>* Se utiliza en los verbos que terminan en <b>ger</b>, <b>gir</b>, <b>giar</b>, por ejemplo:</p>
                                                       ...
                                                       <p>* Palabras que terminan con <b>gia</b> y <b>gio</b> y sus derivados, por ejemplo: </p>
                                                       ...
                                                       <p>* Conjugaciones de los verbos que terminan en <b>ducir</b>, por ejemplo: </p>
                                                       <p> Conducir / Condu<b>j</b>e, Deducir / Dedu<b>j</b>e </p>
                                                       <p>* Verbos terminados en <b>jear</b> y sus conjugaciones, por ejemplo: </p>
                                                       <p> Co<b>j</b>ear, flo<b>j</b>ear </p>
                                                       <p>* Sustantivos terminados en <b>jero</b> y <b>jería</b>, por ejemplo: </p>
      ...
      Lección 5: Uso de la H y sin H
                                                ...
                                                <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSeven">
                                                    <div class="panel-body">
                                                        <h3> Uso de la H </h3>
                                                        <p>* Todas las palabras que comienzan con <b>idr</b>, <b>iper</b>, <b>ipo</b>, por ejemplo: </p>
                                                        <p><b>H</b>idráulico, <b>h</b>idrante, <b>h</b>ipo </p>
                                                        <p>* Silabas que comienzan con <b>om</b>, <b>on</b>, <b>or</b> y <b>er</b>, por ejemplo:</p>
                                                        ...
                                                        <h3> Sin H </h3>
                                                        <p>* No se utiliza la <b>h</b> cuando en los derivados  se pierde el diptongo al inicio de la palabra, por ejemplo: </p>
                                                        <p> orfandad /<b>h</b>uérfano, óseo / <b>h</b>ueso </p>
                                                        <p>* Algunas palabras sin <b>h</b> cambian su significado, por ejemplo: </p>
                                                        <p> Errar: equivocarse / <b>h</b>errar: poner herraduras, ay: exclamación / <b>h</b>ay: del verbo haber </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="panel panel-default">
          ...
          Lección 6: Uso de la M-N, Y-LL, R-RR</a></h4>
                                                ...
                                                <div id="collapseEight" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingEight">
                                                    <div class="panel-body">
                                                        ...
                                                        <p>* Cuando una palabra empieza con <b>n</b> y con prefijos <b>en</b>, <b>in</b>, la <b>n</b> se escribe doble, por ejemplo:</p>
                                                        <p>I<b>nn</b>ovador, i<b>nn</b>erente</p>
                                                        
                                                        <h3> Uso de la Y </h3>
                                                        <p>* Al final de una palabra que termina en diptongo pero no tiene acentuación, por ejemplo: </p>
                                                        ...
                                                        <p> * Palabras que terminan en <b>illo</b>, <b>illa</b>, <b>ello</b>, <b>ella</b>, por ejemplo: </p>
                                                        <p> Pasi<b>ll</b>o, maravi<b>ll</b>a, paneci<b>ll</b>o, sombri<b>ll</b>a, estre<b>ll</b>a, bote<b>ll</b>a </p>
                                                        <p>* Palabras que comienzan con <b>vice</b>, <b>villa</b>, por ejemplo: </p>
                                                        <p> <b>V</b>icepresidente, <b>V</b>illano </p>
                                                        <p> Excepto: Bicentenario, Billar. </p>
                                                    </div>
                                    ...
                                    <div class="tab-pane" id="lC">
                                     ...
                                     <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseNine" aria-expanded="true" aria-controls="collapseNine"> Lección 7: Parónimos</a> </h4>
                                                ...
                                                <div id="collapseNine" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingNine">
                                                    <div class="panel-body">
                                                       <p>Los parónimos son palabras muy parecidas en su pronunciación y escritura pero muy diferentes en su significado.</p>
                                                       <p> Para los que están aprendiendo nuevos idiomas pueden resultarles dificil entenderlos, ya que si no se habla claro puede resultar en confusiones, aqui unos ejemplos de palabras parónimas:</p>
                                                       <p> Adaptar: Ajustar / Adoptar: Adquirir </p>
                                                       <p> Adición: Añadidura o agregación de una cosa a otra / Adicción: Dependencia del organismo de alguna sustancia o droga a la que se ha habituado </p>
                                                       ...
                                                       <p> Espiar: Observar o escuchar a escondidas lo que alguien dice o hace / Expiar: Borrar las culpas por medio de algún sacrificio.</p>
      ...
      Lección 8: Palabras juntas o separadas
                                                ...
                                                <div id="collapseTen" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTen">
                                                    <div class="panel-body">
                                                        <p>En el idioma español existen palabras que se escriben juntas o separadas dependiendo de la expresión.</p>
                                                        <p>Al escribirlas juntas o separas cambia totalmente la idea de lo que se quiere comunicar, por ejemplo las siguientes palabras:</p>
                                                        <p> Abordo: pertenece al verbo abordar/ A bordo: Modo adverbial que refiere a estar en un barco</p>
  ...
  <div class="panel panel-default">
    ...
    <div id="collapseUno" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingUno">
      <div class="panel-body">
        <h3> Acentuación </h3>
        <p> Las acentuaciones se utilizan para diferenciar las palabras que puedan llegar a escribirse de la misma forma, pero que tienen un significado diferente; dependiendo del lugar de acentuación se clasifican en 4 tipos: </p>
        <p> La sílaba tónica es la sílaba de la palabra en la que se produce la acentuación.</p>
        <table class="table table-striped">
            <td>Clasificación </td> <td>Sílaba tónica </td>
</table>
      </div>
    </div>
  </div>
                    ...
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <p>Use this area of the page to describe your project. The icon above is part of a free icon set
                                by <a href="https://sellfy.com/p/8Q9P/jV3VZ/">Flat Icons</a>. On their website, you can download
...
<!-- Bootstrap
         http://www.jose-aguilar.com/scripts/jquery/twitter-bootstrap/docs/components.html -->
